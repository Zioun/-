...
countBtn.addEventListener('click',function(){
    if(countValue < 1){
        ...
        duaText.innerText = `        
        اَللهم فَاطِرَ السَّمَاواتِ وَالأَرْضِ عَالِمَ الغَيْبِ وَالشَّهَادَةِ ؛ رَبَّ كُلِّ شَيْءٍ وَمَلِيكَهُ، أَشْهَدُ أَنْ لاَ إِلٰهَ إِلاَّ أَنْتَ، أَعُوذُ بِكَ مِنْ شَّرِّ نَفْسِي وَشَرِّ الشَّيْطَانِ وَشِرْكِهِ
        `;
        ...
        duaText.innerText = `        
        اَللّٰھُمَّ عَافِنِیْ فِیْ بَدَنِیْ اَللّٰھُمَّ عَافِنِیْ فِیْ سَمْعِیْ اَللّٰھُمَ عَافِنِیْ فِیْ بَصَرِیْ لَآ اِلَہَ اِلَّااَنْتَ
        `;
